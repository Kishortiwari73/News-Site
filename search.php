    ...
    <div id="main-content">
      <div class="container">
        ...
        <div class="col-md-8">
            ...
            $offset=($page-1)*$limit;
            ?>
             <h2 class="page-heading">Search : <?php echo $id; ?></h2>
             <?php
                # code...
            ...
            user as u on p.author=u.user_id where p.title like '%{$id}%' or p.post_date like '%{$id}'order by post_id desc  ;";
            ...
            ?>
                ...
                <?php } }
                    ...
                    echo '<div class="text-uppercase text-danger"><h1>record not found</h1></div>';
                } ?>

                <?php
                $id1 =  $row['post_id']; 
                $q1="select * from post where title like '%{$id}%' ;";
                ...
                if ($page >1) {
                    # code...
                    $n=$page-1;
                    echo "<li><a href='search.php?id={$id1}&page={$n}' >pre</a></li>";
                }  
                for ($i=1; $i <=$tp ; $i++) { 
                    # code...
                    echo "<li><a href='search.php?id={$id1}&page={$i}'>{$i}</a></li>";
                }
                if ($tp > $page) {
                    # code...
                    $m=$page+1;
                    echo "<li><a href='search.php?id={$id1}&page={$m}' >Next</a></li>";
                }
                echo "</ul>";            
                ?>
            </div>
