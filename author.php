    ...
    <div id="main-content">
      <div class="container">
        ...
        <div class="row">
            ...
            user as u on p.author=u.user_id where p.author='{$id}' order by post_id desc limit {$offset},{$limit} ;";
            $r=mysqli_query($con,$q) or die("Error in query");
            // die();
            if (mysqli_num_rows($r)>0) {
                # code...
                while ($row = mysqli_fetch_array($r)) {
            ?><h1 class="post-title text-capitalize"><?php echo $row['category_name']; ?></h1>
                ...
                $q1="select * from post where author={$id} ;";
                ...
                if ($page >1) {
                    # code...
                    $n=$page-1;
                    echo "<li><a href='author.php?id={$id}&page={$n}' >pre</a></li>";
                }  
                for ($i=1; $i <=$tp ; $i++) { 
                    # code...
                ...
                if ($tp > $page) {
                    # code...
                    $m=$page+1;
                    echo "<li><a href='author.php?id={$id}&page={$m}' >Next</a></li>";
                }
                echo "</ul>";            
                ?>
            </div>
